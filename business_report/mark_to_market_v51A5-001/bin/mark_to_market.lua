...
function proc(deposits,depositList,portList,positionList,context)
  ...
  for _,deposit in pairs(deposits) do
    ...
    depositItem = getDepositItem(DEPOSIT_obj)
    ...
    --print(utils.prettystr(portList))
  end  
end
...
function getPortList(deposit_id,portList,portfolio)
  ...
  --print('----------------')
 --print('Port List : ',utils.prettystr(portList))
  --return portList
end

function getDepositItem(deposit)
  -- body
...
function getPositionList(positions,context,positionList)
  ...
  for _,position in pairs(positions) do
    ...
    --print("type of position : ",utils.prettystr(type(position)))
